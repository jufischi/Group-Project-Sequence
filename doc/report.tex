...
geographic spread that is calculated. This is indicated in Figure~\ref{fig:world_comp}, which plots only one data point per country instead of all airports. Still, we can see
...
and \todo{??} (i.e. the virus is not only spreading via air travel but also via direct
