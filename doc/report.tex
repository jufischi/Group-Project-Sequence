...
From the reconstructed phylogeographic trees, the hot-spots, i.e. the airports that contributed the most, of the spread of the 2009 H1N1 can be inferred. Table \ref{tab: hotspots airport effective} shows the top 11 \todo{show less? maybe 6} hot spots when we reconstruct the tree using effective airport data. \todo{wright more about other tables (if we use this at all)}
\begin{table}[h!]
\centering
\begin{tabular}{r|c}
